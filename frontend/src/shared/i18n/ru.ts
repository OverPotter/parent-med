...
export const ru: Translations = {
  ...
  landing: {
    hero: {
      eyebrow: "Семейный трекер здоровья ребёнка",
      title: "Всё важное о ребёнке в одном месте",
      lead:
        "Семье проще вести наблюдение за ребёнком, держать под рукой лекарства, домашнюю аптечку и важные записи в одном месте, чтобы не терять детали между сообщениями, заметками и памятью.",
    ...
    cards: [
      ...
      },
      {
        ...
        description:
          "Одна общая картина помогает семье быстрее договориться и ничего не упустить.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Следующие шаги и важные действия остаются рядом, когда они действительно нужны.",
      },
    ],
    product: {
