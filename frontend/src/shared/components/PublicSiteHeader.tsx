...
function renderHeaderAction(
  ...
  return (
    <Link key={action.label} to={action.to} className={className} onClick={blurActiveField}>
      {action.label}
    </Link>
  );
}
            ...
            <div className="auth-v3-header">
              ...
              <div className="auth-v3-header-actions">
                {resolvedActions.map((action) =>
                  renderHeaderAction(action, "app-header-utility-button")
                )}
                <LanguageSwitch
        ...
        <div className="landing-hero-reset-actions-shell">
          <div className="landing-hero-reset-actions-inline">
            ...
            {resolvedActions.map((action) =>
              renderHeaderAction(
                action,
                "landing-topline-button rounded-full focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/15"
              )
            )}
            <LanguageSwitch
