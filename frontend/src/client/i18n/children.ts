...
export const childrenCopy = {
  ru: {
    common: {
      ...
      networkProblemDescription: "Не удалось загрузить данные. Попробуйте позже.",
      networkProblemInline: "Проблема с сетью. Попробуйте позже.",
    },
    childrenPage: {
      title: "Дети",
      ...
      childCard: {
        ...
        stopFeedingConfirmDescription: "Таймер остановится сейчас. Время вручную менять не нужно.",
        ...
        joinObservation: "Присоединиться",
        joiningObservation: "Подключаем…",
        profile: "Профиль",
    ...
    childProfile: {
      ...
      feedingSectionActive: "Кормление идёт сейчас",
      ...
      feedingNote: "Заметка",
      feedingStatusActive: "Идёт сейчас",
      feedingStatusCompleted: "Сохранено",
      sleepSection: "Сон",
  ...
  en: {
    common: {
      ...
      networkProblemDescription: "Could not load data. Please try again later.",
      networkProblemInline: "Network problem. Please try again later.",
    },
    childrenPage: {
      title: "Children",
      ...
      childCard: {
        ...
        stopFeedingConfirmDescription: "The timer will stop now. Time is captured automatically.",
        ...
        joinObservation: "Join tracking",
        joiningObservation: "Joining…",
        profile: "Profile",
    ...
    childProfile: {
      ...
      feedingSectionActive: "Feeding in progress now",
      ...
      feedingNote: "Note",
      feedingStatusActive: "In progress",
      feedingStatusCompleted: "Saved",
      sleepSection: "Sleep",
