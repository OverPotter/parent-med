...
export function buildMoreScreenContent(
  ...
  return {
    ...
    displayNameLabel: isRu ? "Имя в семье" : isDe ? "Name in der Familie" : isPl ? "Imię w rodzinie" : "Family name",
    phoneLabel: isRu ? "Телефон" : isDe ? "Telefon" : isPl ? "Telefon" : "Phone",
    relationshipLabel: isRu ? "Кто я в семье" : isDe ? "Wer ich in der Familie bin" : isPl ? "Kim jestem w rodzinie" : "Who I am in family",
    ...
    noRelationshipValue: isRu ? "Роль не указана" : isDe ? "Keine Familienrolle angegeben" : isPl ? "Rola nie została podana" : "No family title yet",
