...
export const medicineCabinetOverviewStyles = StyleSheet.create({
  ...
  detailsPrimaryTagGreen: {
    backgroundColor: "#EEE7FF",
  },
  detailsPrimaryTagText: {
    fontSize: 12,
    lineHeight: 14,
    fontWeight: "500",
  },
  detailsPrimaryTagTextGreen: {
    color: "#7A63D6",
  },
  detailsFactGrid: {
    flexDirection: "row",
  ...
  detailsFactCardDanger: {
    backgroundColor: "#FFF0F0",
    borderColor: "#F3CACA",
  },
  detailsFactCardWarning: {
