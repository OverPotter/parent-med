...
export const styles = StyleSheet.create({
  ...
  debugActionChipPrimary: {
    backgroundColor: "#F18169",
    borderColor: "#F18169",
  },
  debugActionChipSecondary: {
    backgroundColor: "#FFF8F2",
    borderColor: "#E9D6CD",
  },
  debugActionChipPrimaryText: {
    color: "#FFFDF9",
    fontSize: 12,
    lineHeight: 15,
    fontWeight: "800",
  },
  debugActionChipSecondaryText: {
    color: "#6D5F59",
    fontSize: 12,
    lineHeight: 15,
    fontWeight: "700",
  ...
  deleteConfirmBackdrop: {
    backgroundColor: "rgba(36, 25, 20, 0.34)",
  },
  deleteConfirmSheet: {
