"""drop family invite handoffs table

Revision ID: 070_drop_family_invite_handoffs
Revises: 069_family_invite_handoffs
...
revision: str = "070_drop_family_invite_handoffs"
down_revision: str | None = "069_family_invite_handoffs"
...
def upgrade() -> None:
    ...
    if inspector.has_table("family_invite_handoffs"):
        indexes = {index["name"] for index in inspector.get_indexes("family_invite_handoffs")}
        if "ix_family_invite_handoffs_family_id_created_at" in indexes:
            op.drop_index(
