...
class SqlEpisodeMedicationPlanRepository(EpisodeMedicationPlanRepository):
    ...
    def _to_entity(self, m: EpisodeMedicationPlanModel) -> EpisodeMedicationPlan:
        return EpisodeMedicationPlan(
            ...
            calculated_dose_mg=m.calculated_dose_mg,
            calculated_dose_value=m.calculated_dose_value,
            calculated_dose_unit=m.calculated_dose_unit,
            dose_calc_mode=m.dose_calc_mode,
            dose_calc_warning=m.dose_calc_warning,
            manual_dose_override=m.manual_dose_override,
            notes=m.notes,
    ...
    def _to_model(self, e: EpisodeMedicationPlan) -> EpisodeMedicationPlanModel:
        return EpisodeMedicationPlanModel(
            ...
            calculated_dose_mg=e.calculated_dose_mg,
            calculated_dose_value=e.calculated_dose_value,
            calculated_dose_unit=e.calculated_dose_unit,
            dose_calc_mode=e.dose_calc_mode,
            dose_calc_warning=e.dose_calc_warning,
            manual_dose_override=e.manual_dose_override,
            notes=e.notes,
    ...
    async def update(self, entity: EpisodeMedicationPlan) -> EpisodeMedicationPlan:
        ...
        row.calculated_dose_mg = entity.calculated_dose_mg
        row.calculated_dose_value = entity.calculated_dose_value
        row.calculated_dose_unit = entity.calculated_dose_unit
        row.dose_calc_mode = entity.dose_calc_mode
        row.dose_calc_warning = entity.dose_calc_warning
        row.manual_dose_override = entity.manual_dose_override
