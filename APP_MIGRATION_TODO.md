...
- [ ] Добавить удаление аккаунта внутри приложения (UI + API).
- [ ] Добавить Privacy Policy URL и экран с ссылками:
  - [ ] Privacy Policy
  - [ ] Terms of Use
  - [ ] Support / Contact
- [ ] Добавить/проверить медицинский дисклеймер в ключевых экранах.
